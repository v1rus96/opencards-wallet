...
export function BalanceHero({ amount, loading }: { amount: number; loading: boolean }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-zinc-900 to-zinc-800 p-7 text-center">
      <div className="absolute -top-1/2 -left-1/2 h-[200%] w-[200%] bg-[radial-gradient(circle_at_30%_50%,rgba(238,79,57,0.10),transparent_60%)]" />
